...
class CardComment extends StatelessWidget {
  ...
  comment; // Cập nhật kiểu để hỗ trợ likeCount và isLiked
  final bool canDelete;
  final VoidCallback? onDelete;
  final VoidCallback? onEdit;
  final VoidCallback? onLike; // Callback cho hành động thích/bỏ thích
  ...
  Widget build(BuildContext context) {
    ...
    final int likeCount = comment['likeCount'] as int? ?? 0;
